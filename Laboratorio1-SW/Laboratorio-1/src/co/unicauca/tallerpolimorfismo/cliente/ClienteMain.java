...
public static void leerViajes() {
    try {
        ...
        viajes.add(viaje3);
        Viaje viaje4 = new ViajeIndividual("Popayán", "Cartagena", 7350000,new SimpleDateFormat("dd/MM/yyyy").parse("01/07/2019"), new SimpleDateFormat("dd/MM/yyyy").parse("12/07/2019"));
        viajes.add(viaje4);
